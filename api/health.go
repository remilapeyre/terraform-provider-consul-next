...
type HealthCheck struct {
	...
	CheckID     string   `terraform:"check_id"`
	Name        string   `terraform:"name"`
	Status      string   `terraform:"status"`
	Notes       string   `terraform:"notes"`
	Output      string   `terraform:"output"`
	...
	ExposedPort int      `terraform:"exposed_port"`
	PeerName    string   `json:",omitempty" terraform:"peer_name"`

	Definition HealthCheckDefinition `terraform:"definition"`
...
type HealthCheckDefinition struct {
	HTTP                                   string              `terraform:"http"`
	Header                                 map[string][]string `terraform:"header"`
	Method                                 string              `terraform:"method"`
	Body                                   string              `terraform:"body"`
	TLSServerName                          string              `terraform:"tls_server_name"`
	TLSSkipVerify                          bool                `terraform:"tls_skip_verify"`
	TCP                                    string              `terraform:"tcp"`
	UDP                                    string              `terraform:"udp"`
	GRPC                                   string              `terraform:"grpc"`
	OSService                              string              `terraform:"os_service"`
	GRPCUseTLS                             bool                `terraform:"grpc_use_tls"`
	IntervalDuration                       time.Duration       `json:"-" terraform:"interval_duration"`
	TimeoutDuration                        time.Duration       `json:"-" terraform:"timeout_duration"`
	DeregisterCriticalServiceAfterDuration time.Duration       `json:"-" terraform:"deregister_critical_service_after_duration"`
