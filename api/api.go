...
type HttpBasicAuth struct {
	...
	Password string `terraform:"password"`
}
...
type Config struct {
	...
	Scheme string `terraform:"scheme"`
	...
	PathPrefix string `terraform:"path_prefix"`
	...
	HttpAuth *HttpBasicAuth `terraform:"http_auth"`
	...
	TokenFile string `terraform:"token_file"`
	...
	TLSConfig TLSConfig `terraform:"tls_config"`
}
