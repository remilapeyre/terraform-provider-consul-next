...
type AgentServiceConnectProxyConfig struct {
	EnvoyExtensions        []EnvoyExtension        `json:",omitempty" terraform:"envoy_extensions"`
	DestinationServiceName string                  `json:",omitempty" terraform:"destination_service_name"`
	DestinationServiceID   string                  `json:",omitempty" terraform:"destination_service_id"`
	LocalServiceAddress    string                  `json:",omitempty" terraform:"local_service_address"`
	LocalServicePort       int                     `json:",omitempty" terraform:"local_service_port"`
	LocalServiceSocketPath string                  `json:",omitempty" terraform:"local_service_socket_path"`
...
type Upstream struct {
	DestinationType      UpstreamDestType       `json:",omitempty" terraform:"destination_type"`
	DestinationPartition string                 `json:",omitempty" terraform:"destination_partition"`
	DestinationNamespace string                 `json:",omitempty" terraform:"destination_namespace"`
	DestinationPeer      string                 `json:",omitempty" terraform:"destination_peer"`
	DestinationName      string                 `terraform:"destination_name"`
	Datacenter           string                 `json:",omitempty" terraform:"datacenter"`
	LocalBindAddress     string                 `json:",omitempty" terraform:"local_bind_address"`
	LocalBindPort        int                    `json:",omitempty" terraform:"local_bind_port"`
