...
type CAConfig struct {
	...
	Provider string `terraform:"connect_provider,required"`
	...
	State map[string]string `terraform:"state,computed"`
	...
	ForceWithoutCrossSigning bool `terraform:"force_without_cross_signing"`
