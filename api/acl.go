...
type ACLLink struct {
	ID   string `terraform:"id,optional,computed"`
	Name string `terraform:"name,optional,computed"`
}
...
type ACLToken struct {
	CreateIndex       uint64
	ModifyIndex       uint64
	AccessorID        string `terraform:"accessor_id,computed"`
	SecretID          string
	Description       string                `terraform:"description"`
	Policies          []*ACLTokenPolicyLink `json:",omitempty" terraform:"policies"`
	Roles             []*ACLTokenRoleLink   `json:",omitempty" terraform:"roles"`
	...
	AuthMethodNamespace string `json:",omitempty" terraform:"auth_method_namespace"`
}
...
type ACLServiceIdentity struct {
	ServiceName string   `terraform:"service_name,required"`
	Datacenters []string `json:",omitempty" terraform:"datacenters"`
}
...
type ACLNodeIdentity struct {
	NodeName   string `terraform:"node_name,required"`
...
type ACLPolicy struct {
	...
	Description string   `terraform:"description"`
	Rules       string   `terraform:"rules,required"`
...
type ACLRole struct {
	...
	Name              string                `terraform:"name,required"`
	Description       string                `terraform:"description"`
	Policies          []*ACLRolePolicyLink  `json:",omitempty" terraform:"policies"`
	ServiceIdentities []*ACLServiceIdentity `json:",omitempty" terraform:"service_identities"`
	NodeIdentities    []*ACLNodeIdentity    `json:",omitempty" terraform:"node_identities"`
	Hash              []byte
	CreateIndex       uint64
...
type ACLBindingRule struct {
	ID          string              `terraform:"id,computed"`
	Description string              `terraform:"description"`
	AuthMethod  string              `terraform:"auth_method,required"`
	Selector    string              `terraform:"selector"`
	BindType    BindingRuleBindType `terraform:"bind_type,required"`
	BindName    string              `terraform:"bind_name,required"`
...
type ACLAuthMethod struct {
	Name        string        `terraform:"name,required"`
	Type        string        `terraform:"type,required"`
	DisplayName string        `json:",omitempty" terraform:"display_name"`
	Description string        `json:",omitempty" terraform:"description"`
	MaxTokenTTL time.Duration `json:",omitempty" terraform:"max_token_ttl"`
	...
	TokenLocality string `json:",omitempty" terraform:"token_locality"`
	...
	// Namespacing is a Consul Enterprise feature.
	NamespaceRules []*ACLAuthMethodNamespaceRule `json:",omitempty" terraform:"namespace_rules"`
...
type ACLAuthMethodNamespaceRule struct {
	...
	Selector string `json:",omitempty" terraform:"selector"`
	...
	BindNamespace string `json:",omitempty" terraform:"bind_namespace"`
}
